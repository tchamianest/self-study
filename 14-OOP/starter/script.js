...
// THIS SHOW ME THE ERROR OF PRIVATE
...
acc1.deposit(200).withdrwa(1000).deposit(300).requestloan(10000);
console.log(acc1.getmovement());

// here what we need to do in this methode is to return this to remove the bugs
...
const EVL1 = new EVCL('tchami', 120, 120);
// console.log(EVL1.#charge);

console.log(EVL1.accelerate());
